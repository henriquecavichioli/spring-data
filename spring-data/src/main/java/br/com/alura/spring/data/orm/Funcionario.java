...
public class Funcionario {
	...
	public String toString() {
		return "Funcionario: id: " + id + " |" + " nome: " + nome + " |" + " cpf: " + cpf + " |" + " salario: "
				+ salario + " |" + " data contratacao: " + dataContratacao + " |" + " cargo: " + cargo.getDescricao()
				+ " |" + " unidade de trabalho: " + unidadeTrabalhos;
	}
